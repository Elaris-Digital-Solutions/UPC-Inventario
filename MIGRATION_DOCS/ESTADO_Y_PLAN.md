...
**Todavía no está en el remoto**: existe en el árbol de trabajo, sin comitear.
...
| **T3A** · El mostrador | Entregar, recibir, no-retirado, no-devuelto, anotaciones. **Y la migración 23** *(D-38)*. La primera tanda que **sanciona** | 2.7 | plan escrito, sin ejecutar |
...
- [ ] **2.7** Flujo del operador: verificación operativa (entregas y recepciones) — **es la T3A entera**
      *(D-37)*, y se lleva además la **migración 23** de D-38. Plan en
