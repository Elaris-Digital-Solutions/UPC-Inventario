...
| **T1** · Sesión | `@supabase/ssr`, `proxy.ts`, magic link, `/completar-perfil`, primer admin. **Microsoft sale** *(Q-16)* y entra **D-32**, la migración 22 | 2.4, 2.4-bis | ⏳ **tareas completas**, pendiente el PR y su CI |
