...
| [`FASE_3_TANDA_2.md`](./FASE_3_TANDA_2.md) | Operadores, primer correo y limpieza: la función del primer acceso *(D-80)*, su columna en `/admin/personal`, el **borrado de los datos de demo** y la séptima prueba E2E *(Q-25)*. Migraciones 31 y 32 | ⚠ **ejecutado EN LOCAL el 2026-08-19** · **11 correcciones al diseño + 8 al plan** · 7 tareas · V-1, V-2 y V-3 resueltos y **V-4 no**, porque se mide contra producción · **cierra Q-25**, **amplía Q-20** · 200 aserciones en 33 archivos, 158 de Vitest, E2E 7/7 · **no está en producción hasta el `db push`** |
