...
| [`FASE_3_TANDA_3.md`](./FASE_3_TANDA_3.md) | Imágenes en los paneles: miniatura en la lista de inventario y en el mostrador, lightbox, y **la medición de Q-20 por la vía del nonce**. **Cero migraciones** | 📝 **escrito el 2026-08-19, sin ejecutar** · **13 correcciones al diseño** · 7 tareas · 5 puntos a verificar · **D-87**, con las tres decisiones de alcance de Alejandro · ⚠ **la trampa nº 1 INVERTIDA:** el `seed.sql` apunta a una URL que da **404** y producción da **200**, así que se vería roto en local y bien en el sitio real · **Q-20 gana una tercera cura** —`setNonce()`, leída en las dependencias— que **no es peor que la enfermedad**, y la tanda la mide con las dos salidas escritas por delante |
