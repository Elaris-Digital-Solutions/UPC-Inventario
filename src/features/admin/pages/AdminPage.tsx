...
import { BarChart3, Boxes, CalendarOff, ClipboardCheck, ClipboardList, ImageIcon, LogOut, PackagePlus } from 'lucide-react';
...
type AdminTab = 'register' | 'manage' | 'images' | 'reservations' | 'verification' | 'stats' | 'disabled_days';
...
const TABS: { id: AdminTab; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'disabled_days', label: 'Días inhabilitados', icon: <CalendarOff className="h-4 w-4" /> },
];
