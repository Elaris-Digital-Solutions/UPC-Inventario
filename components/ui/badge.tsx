...
const badgeVariants = cva(
  // Sin `h-5` y con `rounded-full`: el alto lo decide el padding, como en el
  // Vite (MIGRATION_GUIDE/src/components/ui/badge.tsx:7). Con la altura
  // clavada a 20px el distintivo no crecia con su propio texto, y
  // `font-semibold` en vez de `font-medium` es lo que lo hacia legible a
  // 12px sobre el gris del catalogo.
